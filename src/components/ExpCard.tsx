  ...
  return (
    <div className="mx-auto mb-4 max-w-96">
      ...
      <a
        ...
        target="_blank"
      >
        <span className="margin bg-gradient-to-r from-sky-500 to-sky-900 bg-[length:0%_2px] bg-left-bottom bg-no-repeat transition-all duration-500 ease-out group-hover:bg-[length:100%_2px]">
          {t("see_project")}
        </span>
      </a>
    </div>
